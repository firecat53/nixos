...
}:
{
  ...
  programs.bash = {
    ...
    shellAliases = {
      ...
      um = "udiskie-mount";
      uu = "udiskie-umount";
      vps = "et vps_wg -c 'tmux new-session -A -s term'";
  ...
  programs.fzf = {
    ...
    defaultCommand = "fd --type d --hidden --follow --exclude .git -E .cache -E .nvm -E .cargo -E .local/src -E .local/srv/git -E .vscode-oss -E .local/lib -E .vagrant.d -E .local/share/containers -E .nix-defexpr -E .nix-profile -E .local/state";
    changeDirWidgetCommand = "fd --type d --hidden --follow --exclude .git -E .cache -E .nvm -E .cargo -E .local/src -E .local/srv/git -E .vscode-oss -E .local/lib -E .vagrant.d -E .local/share/containers -E .nix-defexpr -E .nix-profile -E .local/state";
    fileWidgetCommand = "fd --type d --hidden --follow --exclude .git -E .cache -E .nvm -E .cargo -E .local/src -E .local/srv/git -E .vscode-oss -E .local/lib -E .vagrant.d -E .local/share/containers -E .nix-defexpr -E .nix-profile -E .local/state";
