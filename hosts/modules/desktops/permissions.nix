...
#   fd -t d . /home/firecat53/docs /home/firecat53/shared -x chmod g+sw {}
let
  dirs = [
    "/home/firecat53/docs"
    "/home/firecat53/shared"
  ];
  acls = "default:user::rwx,default:user:firecat53:rwx,default:group::rwx,default:group:firecat53:rwx,default:mask::rwx,default:other::r-x";
in
{
  systemd.tmpfiles.rules =
    (map (dir: "d ${dir} 2775 firecat53 firecat53 - -") dirs)
